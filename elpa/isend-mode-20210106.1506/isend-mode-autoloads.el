;;; isend-mode-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(autoload 'isend-default-shell-setup "isend-mode" nil nil nil)

(autoload 'isend-default-python-setup "isend-mode" nil nil nil)

(autoload 'isend-default-ipython-setup "isend-mode" nil nil nil)

(autoload 'isend-default-julia-setup "isend-mode" nil nil nil)
...
(register-definition-prefixes "isend-mode" '("isend-"))
